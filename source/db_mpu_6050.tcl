...
# Generated on: Fri Aug 06 15:00:41 2021
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "MPU_6050"]} {
		puts "Project MPU_6050 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists MPU_6050]} {
		project_open -revision MPU_6050 MPU_6050
	} else {
		project_new -revision MPU_6050 MPU_6050
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "17:51:07  AUGUST 02, 2021"
	...
	set_global_assignment -name EDA_NATIVELINK_SIMULATION_TEST_BENCH top_mpu_6050_vlg_tst -section_id eda_simulation
	set_global_assignment -name ENABLE_SIGNALTAP ON
	set_global_assignment -name USE_SIGNALTAP_FILE output_files/stp1.stp
	set_global_assignment -name EDA_TEST_BENCH_NAME top_mpu_6050_vlg_tst -section_id eda_simulation
	set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NA -section_id top_mpu_6050_vlg_tst
	set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME top_mpu_6050_vlg_tst -section_id top_mpu_6050_vlg_tst
	set_global_assignment -name EDA_TEST_BENCH_FILE simulation/modelsim/top_mpu_6050.vt -section_id top_mpu_6050_vlg_tst
	set_global_assignment -name VERILOG_FILE src/db_mpu_6050.v
	set_global_assignment -name VERILOG_FILE src/top_mpu_6050.v
	set_global_assignment -name VERILOG_FILE src/controller.v
	set_global_assignment -name VERILOG_FILE src/rom_instr.v
	set_global_assignment -name VERILOG_FILE src/i2c_master.v
	set_global_assignment -name VERILOG_FILE src/i2c_fsm.v
	set_global_assignment -name VERILOG_FILE src/i2c_clk_div.v
	set_global_assignment -name SDC_FILE src/db_mpu_6050.sdc
	...
	set_location_assignment PIN_AA20 -to IO_SDA
	set_location_assignment PIN_AC22 -to IO_SCL
